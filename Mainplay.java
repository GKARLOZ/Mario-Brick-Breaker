...
public class Mainplay extends JPanel implements KeyListener, ActionListener{
                    ...
                    
	{
		...
		//ImageIcon i = new ImageIcon("MarioBrickBreaker/bg4.png");
                  ImageIcon i = new ImageIcon("src/MarioBrickBreaker/bg4.png");

		pic = i.getImage();
		
		ImageIcon p = new ImageIcon("src/MarioBrickBreaker/loser.gif");
		losePic = p.getImage();
		
		ImageIcon o = new ImageIcon("src/MarioBrickBreaker/yoshio.gif");
		yoshi = o.getImage();
		
		ImageIcon h = new ImageIcon("src/MarioBrickBreaker/paddle.png");
		paddle = h.getImage();
