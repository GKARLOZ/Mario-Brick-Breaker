...
public class Mainplay extends JPanel implements KeyListener, ActionListener{
	...
	public Mainplay()
	{
		...
		ImageIcon p = new ImageIcon("MarioBrickBreaker/loser.gif");
		losePic = p.getImage();
		
		ImageIcon o = new ImageIcon("MarioBrickBreaker/yoshio.gif");
		yoshi = o.getImage();
		
		ImageIcon h = new ImageIcon("MarioBrickBreaker/paddle.png");
		paddle = h.getImage();
	...
	public void paint(Graphics g ) {
		...
		g.drawImage(paddle,playerX,560,this);
